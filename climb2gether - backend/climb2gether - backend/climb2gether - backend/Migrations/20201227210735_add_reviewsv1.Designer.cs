...
namespace climb2gether___backend.Migrations
{
    ...
    [Migration("20201227210735_add_reviewsv1")]
    partial class add_reviewsv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("climb2gether___backend.Domain.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("climb2gether___backend.Domain.Review", b =>
                {
                    b.HasOne("climb2gether___backend.Domain.User", "Author")
                        .WithMany()
